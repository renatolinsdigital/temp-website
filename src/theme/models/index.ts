export type { default as VisualIdentityColors } from './VisualIdentityColors.model';
export type { default as NeutralColors } from './NeutralColors.model';
...
export type { default as Theme } from './Theme.model';